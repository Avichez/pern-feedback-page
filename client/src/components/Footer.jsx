...
import pinkSmile from "../assets/img/pink-smile.svg";
import yellowSmile from "../assets/img/yellow-smile.svg";
import greenSmile from "../assets/img/green-smile.svg";
import { FooterContainer } from '../App';

const FooterWrapper = styled.footer`
    height: 200px;
    background: #FAFAFA;
    background-image: url("${pinkSmile}"), url("${yellowSmile}"), url("${greenSmile}");
    background-repeat: no-repeat, no-repeat, no-repeat;
    background-position: bottom left, center right -40px, top right 140px;
